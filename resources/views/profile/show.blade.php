...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-12 mb-4">
            <img src="{{ asset('storage/' . ($user->bannerImage ? $user->bannerImage->url : 'https://via.placeholder.com/50')) }}"
                class="img-fluid rounded" alt="Banner Image">
        </div>
        <!-- Profile Image and Info -->
        <div class="col-md-4 text-center">
            <img src="{{ asset('storage/' . ($user->profileImage ? $user->profileImage->url : 'https://via.placeholder.com/50')) }}"
                class="img-fluid rounded-circle mb-3" alt="Profile Image" style="width: 150px; height: 150px;">
            <h2>{{ $user->username }}</h2>
            <h4>{{ $user->nickname }}</h4>
            <p>{{ $user->bio }}</p>
            @auth
